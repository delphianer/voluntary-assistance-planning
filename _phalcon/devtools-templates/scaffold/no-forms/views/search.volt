<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("$plural$/index", "Zurück", 'class': 'btn btn-outline-primary btn-sm') }}</li>
            <li class="next">{{ link_to("$plural$/new", "Neu", 'class': 'btn btn-outline-success') }}</li>
        </ul>
    </nav>
</div>
