<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("certificates", "Zurück", 'class': 'btn btn-outline-primary btn-sm') }}</li>
        </ul>
    </nav>
</div>

<div class="page-header">
    <h1>certificates bearbeiten</h1>
</div>

{{ content() }}

<form action="certificates/save" class="form-horizontal" method="post">
